...
def fetch_cards(update=False, filename='program/magic_cards.json'):
    '''Henter kortdata fra Scryfall, men beholder eksisterende kort i magic_cards.json om filen finnes.'''
    ...
    updated_cards = existing_cards.copy()  # Start med eksisterende kort
    ...
    for card in json_data:
        try:
            ...
            # Oppdater kun om kortet ikke finnes fra før
